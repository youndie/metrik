...
fun align(
    ...
    from: Long,
    to: Long,
    value: (io.github.youndie.metrik.api.TimePoint) -> Double = { it.p95Ms },
): List<Double?> {
...
fun deployColumns(
    deploys: List<io.github.youndie.metrik.api.DeployMarker>,
    from: Long,
    to: Long,
    step: Step,
    columns: Int,
 ...
 */
fun latencyThresholds(rules: List<io.github.youndie.metrik.api.AlertRuleView>): Thresholds {
