 ...
 *
 * Порог намеренно щедрый: тест ловит регрессию на порядок (лишний лок, аллокация строки на запрос,
 * лишняя сериализация), а не колебания CI. Фактические числа печатаются — они и есть полезная часть.
 */
